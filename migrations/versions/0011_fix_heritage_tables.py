...
def upgrade() -> None:
    ...
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'PENDING' TO 'pendente'"
    )
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'APPROVED' TO 'aprovado'"
    )
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'REJECTED' TO 'reprovado'"
    )
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'DELIVERED' TO 'entregue'"
    )
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'RETURNED' TO 'devolvido'"
    )
    ...
    op.execute(
        "ALTER INDEX ix_request_item_id RENAME TO ix_heritage_request_item_id"
    )
...
def downgrade() -> None:
    ...
    op.execute(
        "ALTER INDEX ix_heritage_request_item_id RENAME TO ix_request_item_id"
    )
    ...
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'devolvido' TO 'RETURNED'"
    )
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'entregue' TO 'DELIVERED'"
    )
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'reprovado' TO 'REJECTED'"
    )
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'aprovado' TO 'APPROVED'"
    )
    op.execute(
        "ALTER TYPE requeststatusconcept RENAME VALUE 'pendente' TO 'PENDING'"
    )
