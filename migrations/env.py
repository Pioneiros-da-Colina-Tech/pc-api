...
from app.infra.database.adapter import metadata
from app.infra.database.config import (
    ConnectionConfig,
    DatabaseConfig,
    PoolConfig,
)
from app.infra.database.entities import Entity
from app.settings import ROOT, database_settings

_child_validator = runtime_child_of(Entity)
...
# env.py
def process_revision_directives(context, _, directives):  # pyright: ignore[reportMissingParameterType]]
    # extract Migration
...
_ = RuntimeAutoDiscovery(_multivalidate, ROOT, exclude=("common",)).asdict
